...
export default function AdminUserDetailScreen({ route, navigation }) {
      ...
      <View style={styles.bookInfo}>
        ...
        <View style={styles.bookStats}>
          <View style={styles.bookStatItem}>
            <BookIcon size={14} color="#999" />
            <Text style={styles.bookStat}>{book.chapter_count || 0}</Text>
          </View>
          <View style={styles.bookStatItem}>
            <HeartIcon size={14} color="#999" />
            <Text style={styles.bookStat}>{book.like_count || 0}</Text>
          </View>
          <View style={styles.bookStatItem}>
            <EyeIcon size={14} color="#999" />
            <Text style={styles.bookStat}>{book.view_count || 0}</Text>
          </View>
        </View>
        ...
        <View style={styles.bookActions}>
          ...
          >
            ...
            <Text style={styles.deleteBookButtonText}>Eliminar</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.actionsSection}>
          ...
          >
            <TrashIcon
              size={20}
              color="#FFF"
              style={styles.deleteUserButtonIcon}
            />
          ...
          {books.length === 0 ? (
            <View style={styles.emptyBooks}>
              <Text style={styles.emptyBooksText}>
                Este usuario no ha publicado ningún libro todavía
              </Text>
            </View>
          ) : (
      ...
      {/* Modal de Confirmación - Bibliotecario */}
      <Modal
            ...
            <Text style={styles.modalText}>
              {user?.is_librarian ? (
                <>
                  ...
                  <Text style={styles.boldText}>quitar el rol</Text> de
                  bibliotecario a{" "}
                  <Text style={styles.boldText}>{user?.username}</Text>?{"\n\n"}
                  El usuario perderá los siguientes permisos:
                  {"\n"}• Gestionar reportes de contenido
                  {"\n"}• Eliminar libros reportados
                  {"\n"}• Ocultar capítulos inapropiados
                </>
              ) : (
                <>
                  ¿Estás seguro de que deseas{" "}
                  <Text style={styles.boldText}>asignar el rol</Text> de
                  bibliotecario a{" "}
                  <Text style={styles.boldText}>{user?.username}</Text>?{"\n\n"}
                  El usuario obtendrá los siguientes permisos:
                  {"\n"}• Gestionar reportes de contenido
                  {"\n"}• Eliminar libros reportados
                  {"\n"}• Ocultar capítulos inapropiados
                </>
      ...
      {/* Modal de Confirmación - Eliminar Libro */}
      <Modal
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalText}>
              ...
              {"\n\n"}
              Se eliminarán todos sus capítulos y comentarios asociados.
            </Text>
