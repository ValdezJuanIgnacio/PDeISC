...
export default function WriteScreen({ navigation }) {
  ...
  const loadDraft = async () => {
    try {
      ...
      if (draftStr) {
        ...
        Alert.alert(
          "Borrador encontrado",
          `Se encontró un borrador de "${draft.bookTitle}". Â¿Deseas recuperarlo?`,
          [
    ...
    try {
      ...
      if (!result.canceled) {
        ...
        try {
          ...
          Alert.alert("Ã¢Å“â€¦ Éxito", "Imagen de portada cargada");
        } catch (error) {
    ...
    try {
      ...
      if (!result.canceled) {
        ...
        try {
          ...
          const uploadedUrl = await uploadImageToServer(result.assets[0].uri);
          setCoverUrl(uploadedUrl);
          Alert.alert("Ã¢Å“â€¦ Éxito", "Foto de portada cargada");
        } catch (error) {
  ...
  const handleDeleteChapter = (chapterId) => {
    Alert.alert(
      "Eliminar capítulo",
      "Â¿Estás seguro de que deseas eliminar este capítulo?",
      [
  ...
  // Modal para ingresar título del capítulo - Optimizado para evitar parpadeo
  ...
  // NUEVA FUNCIÃƒâ€œN: Publicar o actualizar libro - CON MEJOR MANEJO WEB
  const handlePublishBook = async () => {
    ...
    const message = isPublished
      ? "Â¿Deseas actualizar la publicación de este libro? Los cambios serán visibles inmediatamente para los lectores."
      : "Â¿Deseas publicar este libro? Será visible para todos los lectores en la sección de Explorar.";
    ...
    const executePublish = async () => {
      ...
      try {
        console.log(
          `Ã°Å¸â€œÂ ${isPublished ? "Actualizando" : "Publicando"} libro:`,
          currentBookId
        );
        ...
        try {
          ...
          console.log(
            "Ã°Å¸â€œÂ¬ Response from publish:",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {pendingPublishAction?.message || "Â¿Deseas continuar?"}
          </Text>
  ...
  const handleUnpublishBook = async () => {
    ...
    const confirmMessage =
      "Â¿Deseas desbloquear este libro? Dejará de ser visible en la biblioteca pública y podrás editarlo nuevamente.";
            ...
            <View style={styles.modalOverlay}>
              <View style={styles.imagePickerModalContent}>
                ...
                >
                  ...
                  >
                    <ImageGalleryIcon size={20} color="#B87D5F" />
                ...
                >
                  ...
                  >
                    <CameraIcon size={20} color="#B87D5F" />
                    <Text style={styles.imagePickerOptionText}>
                      Tomar una foto
                    </Text>
                  </View>
            ...
            <View style={styles.publishSection}>
              ...
              >
                {loading ? (
                  ...
                  <Text style={styles.buttonText}>
                    Ã°Å¸â€â€ž Actualizar Publicación
                  </Text>
                )}
              </TouchableOpacity>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.imagePickerModalContent}>
            ...
            >
              <Text style={styles.imagePickerOptionText}>
                Ã°Å¸â€“Â¼Ã¯Â¸Â Elegir de la galería
              </Text>
            </TouchableOpacity>
