        ...
        <View style={styles.guestContainer}>
          ...
          <View style={styles.guestFeatures}>
            <View style={styles.featureItem}>
              <BookIcon size={28} color="#B87D5F" />
              <Text style={styles.featureText}>
                Guarda tus libros favoritos
              </Text>
            </View>
            <View style={styles.featureItem}>
              <CommentIcon size={28} color="#B87D5F" />
              <Text style={styles.featureText}>Comenta y participa</Text>
            </View>
            <View style={styles.featureItem}>
              <PenIcon size={28} color="#B87D5F" />
              <Text style={styles.featureText}>
                Escribe tus propias historias
              </Text>
            </View>
            <View style={styles.featureItem}>
              <HeartIcon size={28} color="#B87D5F" />
              <Text style={styles.featureText}>
      ...
      <View style={styles.bookInfo}>
        ...
        <View style={styles.bookStats}>
          <View style={styles.bookStatItem}>
            ...
            <Text style={styles.bookStat}>{item.view_count || 0}</Text>
          </View>
          <View style={styles.bookStatItem}>
            <HeartIcon size={14} color="#999" filled={false} />
      ...
      <ScrollView>
        ...
        <View style={styles.profileSection}>
          ...
          <View style={styles.profileInfo}>
            ...
            {user?.is_librarian && (
              <View style={[styles.roleBadge, styles.librarianBadge]}>
        ...
        <View style={styles.menuSection}>
          ...
          >
            <View style={styles.menuItemLeft}>
              <HeartIcon size={20} color="#FF5252" filled={true} />
          ...
          >
            <View style={styles.menuItemLeft}>
              <HistoryIcon size={20} color="#B87D5F" />
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            >
              <ImageGalleryIcon size={24} color="#B87D5F" />
            ...
            <TouchableOpacity
              ...
              onPress={takePhoto}
            >
              <CameraIcon size={24} color="#B87D5F" />
