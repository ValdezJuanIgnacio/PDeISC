...
export default function LibraryScreen({ navigation }) {
  ...
  // Recargar libros cada vez que la pantalla obtiene el foco
  useFocusEffect(
    React.useCallback(() => {
      loadBooks();
    }, [])
            ...
            {selectedBook && (
              <View style={styles.selectedBookInfo}>
                ...
                <Text style={styles.selectedBookAuthor}>
                  {selectedBook.writer_name}
                </Text>
              </View>
            )}

            <Text style={styles.modalLabel}>Razón del reporte:</Text>
            <TextInput
              style={styles.reportInput}
              placeholder="Describe por qué este libro debe ser revisado..."
              value={reportReason}
